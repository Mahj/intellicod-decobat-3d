 ...
 * @generated
 */
public class DecobatSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DecobatPackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.PROJECT_CATEGORY: {
				ProjectCategory projectCategory = (ProjectCategory)theEObject;
				T result = caseProjectCategory(projectCategory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.PROJECT_REVISION: {
				ProjectRevision projectRevision = (ProjectRevision)theEObject;
				T result = caseProjectRevision(projectRevision);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.LIBRARY: {
				Library library = (Library)theEObject;
				T result = caseLibrary(library);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.LIBRARY_CATEGORY: {
				LibraryCategory libraryCategory = (LibraryCategory)theEObject;
				T result = caseLibraryCategory(libraryCategory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.PRODUCT: {
				Product product = (Product)theEObject;
				T result = caseProduct(product);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.SUPPLIER: {
				Supplier supplier = (Supplier)theEObject;
				T result = caseSupplier(supplier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.SERVICE: {
				Service service = (Service)theEObject;
				T result = caseService(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.PLAN: {
				Plan plan = (Plan)theEObject;
				T result = casePlan(plan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecobatPackage.LEVEL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Project Category</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Project Category</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProjectCategory(ProjectCategory object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Project Revision</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Project Revision</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProjectRevision(ProjectRevision object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseLibraryCategory(LibraryCategory object) {
		return null;
	}
